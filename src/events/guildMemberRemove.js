...
module.exports.event =  async(member) => {
    ...
    ctx.fillText(`Aurevoir ${member.user.tag}`, 512, 410);
    ...
    .setDescription(`${member} vient de quitté le serveur`)
    .setImage('attachment://welcome-image.png')
    member.guild.channels.cache.get(query.leaveChannelId).send({embeds: [embed], files: [attachment]})
}
